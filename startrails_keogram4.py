...
os.system("logger 'Clanon startrails_keogram4.py started.'")
...
# Log end
os.system("logger 'Clanon startrails_keogram4.py completed. Launching starmap5.py'")
